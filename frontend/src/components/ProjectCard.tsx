...
export default function ProjectCard({
  ...
  return (
    <div className="group bg-white rounded-2xl border border-google-border overflow-hidden hover:border-transparent hover:shadow-xl hover:shadow-black/5 transition-all duration-300">
